...
public class ServiceUtils {
    ...
    public static Set getAllRunningServices() {
        ActivityManager am =
                (ActivityManager) CommonApplication.getApplication().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(CommonApplication.getApplication(), cls);
        CommonApplication.getApplication().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(CommonApplication.getApplication(), cls);
        return CommonApplication.getApplication().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(CommonApplication.getApplication(), cls);
        CommonApplication.getApplication().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        CommonApplication.getApplication().unbindService(conn);
    }
