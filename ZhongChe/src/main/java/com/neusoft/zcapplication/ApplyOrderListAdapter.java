 ...
 * 预定申请单adapter
 */
public class ApplyOrderListAdapter extends BaseAdapter{
    ...
    public ApplyOrderListAdapter(Context context, List<Map<String,Object>> list, int type){
...
//        Log.i("--->","item:" + item);
        ...
        }else if (state.equals("1.0")){
            state = "已审批";
            holder.approval.setVisibility(View.GONE);
        }else if (state.equals("2.0")){
            state = "待审批";
            holder.approval.setVisibility(View.VISIBLE);
        }
