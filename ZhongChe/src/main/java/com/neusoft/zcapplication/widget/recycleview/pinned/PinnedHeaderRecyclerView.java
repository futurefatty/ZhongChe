package com.neusoft.zcapplication.widget.recycleview.pinned;
...
public class PinnedHeaderRecyclerView extends RecyclerView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (getAdapter().getItemCount() != 0 && pinnedHeaderRect.contains((int) ev.getX(), (int) ev.getY())) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (getAdapter().getItemCount() != 0  && pinnedHeaderRect.contains((int) x, (int) y)) {
    ...
    public IPinnedHeaderDecoration getPinnedHeaderDecoration() {
        if (decor instanceof IPinnedHeaderDecoration) {
            return (IPinnedHeaderDecoration) decor;
        } else {
            return null;
        }
    }
