...
public class CalendarActivity extends BaseActivity implements View.OnClickListener,MyCalendarLayout.OnDaySelectListener{
    private static final  int  MAX_MONTH_NUM = 6;
...
//        sd2 = new SimpleDateFormat("dd");
    ...
    private void initView(){
        ...
        AppUtils.setStateBar(CalendarActivity.this,findViewById(R.id.frg_status_bar));
...
//                textTv.setTextColor(Color.WHITE);
                ...
                if(bool){
                    ...
                    ToastUtil.toastNeedData(CalendarActivity.this,"请选择" + selectFirstDay + "之后的日期");
                }
            }
