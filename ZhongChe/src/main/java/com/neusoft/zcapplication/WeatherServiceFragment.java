...
public class WeatherServiceFragment extends BaseFragment implements View.OnClickListener{
    public static WeatherServiceFragment getInstance(){
        WeatherServiceFragment fragment = new WeatherServiceFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(null == frgView){
            frgView = inflater.inflate(R.layout.frg_weather_webview, container, false);
            initView();
    ...
    private void initView(){
        ...
        webView = (WebView) frgView.findViewById(R.id.wv_weather_servie);
...
//        String url = "http://enjoyflyingnow.com/weixin/flight/trends";
        String url = "http://enjoyflyingnow.com/weixin/flight/weather";
