...
import com.neusoft.zcapplication.mine.order.InternalTicketFragment;
...
public class NowJourneyFragment extends BaseFragment implements View.OnClickListener,RequestCallback {
    ...
    public static NowJourneyFragment getInstance(){
        NowJourneyFragment fragment = new NowJourneyFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(null == frgView){
            frgView = inflater.inflate(R.layout.frg_now_journey, container, false);
            initView();
    ...
    private void initView(){
        ListView listView  =  (ListView)frgView.findViewById(R.id.frg_now_list);
        List<Map<String,Object>> list = new ArrayList<>();
        adapter = new NowJourneyAdapter(getActivity(),0,list);
...
//        params.put("employeeCode","20139232");
        ...
        Call<Map<String,Object>> call = request.getScheduleData(params);
