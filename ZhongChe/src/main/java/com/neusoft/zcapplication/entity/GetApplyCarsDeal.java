...
/**
 * Author: TenzLiu
 * Time: 2018/7/10 15:43
 * Desc: 用车详情
 */

public class GetApplyCarsDeal implements Serializable {

    /**
     * id : 73
     * carApplyId : CL2018071608488
     * applicatId : 20110883
     * applicatName : 陈岚君
     * mobile : 18373399973
     * email : 973446095@qq.com
     * unitCode : 01070200
     * applicationDate : 1531723080000
     * carType : 轿车
     * numberPeople : 1
     * startTime : 1531723020000
     * endTime : 1531755420000
     * carRange : 长株潭内
     * applyReason : 1
     * auditPublicStatus : 1
     * auditDate : 1531724527000
     * conductorId : 20107090
     * toMessage : 0
     * supplierId : null
     * createDate : 1531723080000
     * modifyDate : null
     * deleteFlag : N
     * auditId : 79
     * auditLevel : 1
    ...
    private String conductorCompanyName;
    private String applicatorCompanyName;
    ...
    private List<GetApplyCarsAudit.CarAuditEntity> carAuditEntities;

    public List<GetApplyCarsAudit.CarAuditEntity> getCarAuditEntities() {
        return carAuditEntities;
    }

    public void setCarAuditEntities(List<GetApplyCarsAudit.CarAuditEntity> carAuditEntities) {
    ...
    public String getConductorCompanyName() {
        return conductorCompanyName;
    }

    public void setConductorCompanyName(String conductorCompanyName) {
        this.conductorCompanyName = conductorCompanyName;
    }

    public String getApplicatorCompanyName() {
        return applicatorCompanyName;
    }

    public void setApplicatorCompanyName(String applicatorCompanyName) {
        this.applicatorCompanyName = applicatorCompanyName;
    }
