...
public class AirportServiceFragment extends Fragment implements View.OnClickListener{
    public static AirportServiceFragment getInstance(){
        AirportServiceFragment fragment = new AirportServiceFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(null == frgView){
            frgView = inflater.inflate(R.layout.frg_airport_webview, container, false);
            initView();
    ...
    private void initView(){
        ...
        webView = (WebView) frgView.findViewById(R.id.wv_airport_servie);
...
//        String url = "http://enjoyflyingnow.com/weixin/flight/trends";
        String url = "http://enjoyflyingnow.com/weixin/flight/strategy";
