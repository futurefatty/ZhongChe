...
public class personDataFragment extends BaseFragment implements View.OnClickListener{
    ...
    public static personDataFragment getInstance(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(null == fragmentView){
            fragmentView = inflater.inflate(R.layout.fragment_person_data, container, false);
            initView();
        }else{
    ...
    private void initView() {
        fragmentView.findViewById(R.id.ll_yeaer).setOnClickListener(this);
        fragmentView.findViewById(R.id.ll_quarter).setOnClickListener(this);
        fragmentView.findViewById(R.id.ll_month).setOnClickListener(this);
        pv_cost = (PieView) fragmentView.findViewById(R.id.pv_cost);
        ll_domestic_flight_ticket_cost = (LinearLayout) fragmentView.findViewById(R.id.ll_domestic_flight_ticket_cost);
        ll_international_flight_ticket_cost = (LinearLayout) fragmentView.findViewById(R.id.ll_international_flight_ticket_cost);
        ll_hotel_cost = (LinearLayout) fragmentView.findViewById(R.id.ll_hotel_cost);

        tv_year = (TextView) fragmentView.findViewById(R.id.tv_year);
        tv_quarter = (TextView) fragmentView.findViewById(R.id.tv_quarter);
        tv_month = (TextView) fragmentView.findViewById(R.id.tv_month);

        tv_total_cost = (TextView) fragmentView.findViewById(R.id.tv_total_cost);
        tv_domestic_flight_ticket_order_count = (TextView) fragmentView.findViewById(R.id.tv_domestic_flight_ticket_order_count);
        tv_domestic_flight_ticket_total_cost = (TextView) fragmentView.findViewById(R.id.tv_domestic_flight_ticket_total_cost);
        tv_domestic_flight_ticket_per_total_cost = (TextView) fragmentView.findViewById(R.id.tv_domestic_flight_ticket_per_total_cost);
        tv_endorse_flight_ticket_order_count = (TextView) fragmentView.findViewById(R.id.tv_endorse_flight_ticket_order_count);
        tv_endorse_flight_ticket_total_cost = (TextView) fragmentView.findViewById(R.id.tv_endorse_flight_ticket_total_cost);
        tv_endorse_flight_ticket_per_total_cost = (TextView) fragmentView.findViewById(R.id.tv_endorse_flight_ticket_per_total_cost);
        tv_hotel_order_count = (TextView) fragmentView.findViewById(R.id.tv_hotel_order_count);
        tv_hotel_total_cost = (TextView) fragmentView.findViewById(R.id.tv_hotel_total_cost);
        tv_hotel_per_total_cost = (TextView) fragmentView.findViewById(R.id.tv_hotel_per_total_cost);

        tv_advance_domestic = (TextView) fragmentView.findViewById(R.id.tv_advance_domestic);
        tv_advance_international= (TextView) fragmentView.findViewById(R.id.tv_advance_international);
        tv_advance_hotel = (TextView) fragmentView.findViewById(R.id.tv_advance_hotel);
        tv_advance_rank_domestic = (TextView) fragmentView.findViewById(R.id.tv_advance_rank_domestic);
        tv_advance_rank_international = (TextView) fragmentView.findViewById(R.id.tv_advance_rank_international);
        tv_advance_rank_hotel = (TextView) fragmentView.findViewById(R.id.tv_advance_rank_hotel);

        tv_endorse_ticket_total = (TextView) fragmentView.findViewById(R.id.tv_endorse_ticket_total);
        tv_endorse_ticket_domestic = (TextView) fragmentView.findViewById(R.id.tv_endorse_ticket_domestic);
        tv_endorse_ticket_international = (TextView) fragmentView.findViewById(R.id.tv_endorse_ticket_international);
        tv_endorse_rank_per_total = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_per_total);
        tv_endorse_rank_per_domestic = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_per_domestic);
        tv_endorse_rank_per_international = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_per_international);
        tv_endorse_rank_total = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_total);
        tv_endorse_rank_domestic = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_domestic);
        tv_endorse_rank_international = (TextView) fragmentView.findViewById(R.id.tv_endorse_rank_international);

        tv_unsubscribe_ticket_total = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_ticket_total);
        tv_unsubscribe_ticket_domestic = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_ticket_domestic);
        tv_unsubscribe_ticket_international = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_ticket_international);
        tv_unsubscribe_rank_per_total = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_per_total);
        tv_unsubscribe_rank_per_domestic = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_per_domestic);
        tv_unsubscribe_rank_per_international = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_per_international);
        tv_unsubscribe_rank_total = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_total);
        tv_unsubscribe_rank_domestic = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_domestic);
        tv_unsubscribe_rank_international = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_rank_international);

        tv_unsubscribe_hotel_number = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_hotel_number);
        tv_unsubscribe_hotel_percent = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_hotel_percent);
        tv_unsubscribe_hotel_rank = (TextView) fragmentView.findViewById(R.id.tv_unsubscribe_hotel_rank);

        tv_order_hotel_number = (TextView) fragmentView.findViewById(R.id.tv_order_hotel_number);
        tv_order_hotel_percent = (TextView) fragmentView.findViewById(R.id.tv_order_hotel_percent);
        tv_order_hotel_rank = (TextView) fragmentView.findViewById(R.id.tv_order_hotel_rank);

        tv_breach_number_domestic = (TextView) fragmentView.findViewById(R.id.tv_breach_number_domestic);
        tv_breach_number_international = (TextView) fragmentView.findViewById(R.id.tv_breach_number_international);
        tv_breach_number_hotel = (TextView) fragmentView.findViewById(R.id.tv_breach_number_hotel);
        tv_breach_percent_domestic = (TextView) fragmentView.findViewById(R.id.tv_breach_percent_domestic);
        tv_breach_percent_international = (TextView) fragmentView.findViewById(R.id.tv_breach_percent_international);
        tv_breach_percent_hotel = (TextView) fragmentView.findViewById(R.id.tv_breach_percent_hotel);
        tv_breach_rank_domestic = (TextView) fragmentView.findViewById(R.id.tv_breach_rank_domestic);
        tv_breach_rank_international = (TextView) fragmentView.findViewById(R.id.tv_breach_rank_international);
        tv_breach_rank_hotel = (TextView) fragmentView.findViewById(R.id.tv_breach_rank_hotel);

        yearDataList.clear();
        quarterDataList.clear();
        Calendar c = Calendar.getInstance();
        int currentYear = c.get(Calendar.YEAR); // 获取当前年份
        tv_year.setText("" + Integer.valueOf(currentYear) + "");
        ...
        quarterSelector = new SinglePickSelector(getActivity(), new SinglePickSelector.ResultHandler() {
            @Override
            public void handle(String data) {
                if("全部".equals(data)){
                    quarter = -1;
    ...
    public void onMessageEvent(Events.PersonDataHandleChange businessCarHandleChange){
        getPersonalData();
    }
